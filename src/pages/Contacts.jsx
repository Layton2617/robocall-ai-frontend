...
const Contacts = () => {
  ...
  const sidebarItems = [
    ...
    { icon: Users, label: 'Contacts', path: '/contacts', active: true },
        ...
        <main className="flex-1 p-6">
          <Card>
            ...
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-500 mb-6">Upload your first contact list to get started with calling campaigns</p>
              <Button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700">
                <Upload className="w-4 h-4 mr-2" />
                Upload Contact List
              </Button>
